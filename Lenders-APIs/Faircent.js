...
curl -X POST "https://keshvacredit.com/api/v1/LenderAPIs/faircent/upload" \
-H "x-application-id: 1cfa78742af22b054a57fac6cf830699" \
-H "x-application-name: KESHVACREDIT" \
-H "x-access-token: <YOUR_ACCESS_TOKEN>" \
-F "type=BANK_STATEMENT" \
-F "loan_id=1005384685" \
-F "docImage=@./uploads/situ.pdf"
*/
