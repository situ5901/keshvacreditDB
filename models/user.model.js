...
const userSchema = new Schema(
  {
    ...
    type_of_business: { type: String, trim: true },
    date_of_business: { type: String, trim: true },
    company_name: { type: String, trim: true },
    bussiness_address: { type: String, trim: true },
    bank_name: { type: String, trim: true },
    bank_account_number: { type: String, trim: true },
    bank_account_name: { type: String, trim: true },
